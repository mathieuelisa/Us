...
/**
 * Suivi « allaitement » de « Votre bébé » — voir `BabyModuleScreen` et
 * `BABY_MODULES` : la route existe pour porter la navigation depuis la
 * grille bento de `/bebe`, tout le rendu est partagé.
 */
export default function BabyBreastfeedingScreen() {
  return <BabyModuleScreen module={BABY_MODULES.allaitement} />;
}
